...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0005_sitesettings_razorpay'),
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='cart',
            constraint=models.UniqueConstraint(condition=models.Q(('guest_token__isnull', False)), fields=('guest_token',), name='unique_guest_token'),
        ),
